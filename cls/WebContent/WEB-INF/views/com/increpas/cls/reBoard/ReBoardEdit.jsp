...
<body>
	...
	<div class="w3-content mw700">
		<div class="w3-center w3-purple w3-padding mb10">게시글 수정</div>
		<div class="w3-col">
			...
			<form class="w3-rest" id="frm" name="frm">
				...
				<input type="hidden" name="obody" id="obody" value="${param.body}">
				<textarea class="w3-input w3-border h72" style="resize: none;" placeholder="메세지를 작성하세요!" id="body" name="body">${param.body}</textarea>
